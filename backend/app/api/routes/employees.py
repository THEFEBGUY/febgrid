...
def create_employee(payload: EmployeeCreate, db: Session = Depends(db_session)) -> Employee:
...
def get_employee(employee_id: UUID, company_id: UUID, db: Session = Depends(db_session)) -> Employee:
