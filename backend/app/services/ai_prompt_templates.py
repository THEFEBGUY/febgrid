    ...
    return [
        {
            ...
            "content": (
                ...
                "matching the requested output contract. Do not wrap JSON in Markdown or code fences. Do not "
                "include explanatory text before or after the JSON object. For file summaries, summarize only "
                "the provided text, mention when content was truncated, and avoid restating any secret-like values. For document "
